...
public class QueryEmbeddingsBatchRequestTests(ITestOutputHelper output) : NoDisposalNeeded(output)
{
    ...
    public void Creation_InitializesCorrectly()
    {
        ...
        // Act
        using var request = new QueryEmbeddingsBatchRequest([TestValue], callerToken.Token);
    ...
    {
        // Arrange
        using var request = new QueryEmbeddingsBatchRequest([TestValue], CancellationToken.None);
    ...
    public void Dispose_ReleasesResources()
    {
        // Arrange
        var callerToken = new CancellationTokenSource();
        var request = new QueryEmbeddingsBatchRequest([TestValue], callerToken.Token);
