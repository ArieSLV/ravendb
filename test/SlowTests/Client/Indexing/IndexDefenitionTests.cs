...
namespace SlowTests.Client.Indexing
{
    public class IndexDefinitionTests : RavenTestBase
    {
        ...
        public void MapIndex_MemoryExtensionsContains_IntArray_ShouldWork(Options options)
        {
            ...
            var docs = new object[]
            {
                new DocWithStrings { Numbers = [1, 2, 42] },
                new DocWithStrings { Numbers = [1, 2, 3] },
                new DocWithStrings { Numbers = [] }
            };
        ...
        public void MapIndex_MemoryExtensionsContainsAny_IntArrays_ShouldWork(Options options)
        {
            ...
            var docs = new object[]
            {
                new DocWithStrings { Numbers = new[] { 1, 2, 3 } },
                new DocWithStrings { Numbers = new[] { 42, 7 } },
                new DocWithStrings { Numbers = new[] { 100 } }
            };
        ...
        private protected void AssertIndexBuilderRewritesAndRunsCorrectly<TDoc, TReduce>(
            Options options,
